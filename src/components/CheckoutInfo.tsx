...
function CheckoutInfo({
  ...
  return (
    <>
      ...
      <section
        className={`fixed z-20 p-4 rounded-2xl w-1/2 max-h-[85vh] overflow-y-scroll top-1/3 right-1/2 -translate-y-1/3 translate-x-1/2 bg-white dark:bg-slate-800 shadow-lg transition ${
          showInfo
            ? "opacity-100 visible"
