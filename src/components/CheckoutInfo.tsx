...
function CheckoutInfo({
  ...
  return (
    <>
      ...
      <section
        className={`fixed z-20 p-4 rounded-2xl w-[90%] sm:w-4/5 md:w-[70%] lg:w-3/5 xl:w-1/2 2xl:w-2/5 max-h-[85vh] overflow-y-scroll top-1/2 right-1/2 -translate-y-1/2 translate-x-1/2 bg-white dark:bg-slate-800 shadow-lg transition ${
          showInfo
            ? "opacity-100 visible"
